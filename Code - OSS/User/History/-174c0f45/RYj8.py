...
def xrandr_setup():
    subprocess.run([
        ...
        "--output", "HDMI-A-1", "--mode", "1920x1080", "--pos", "1920x-400", "--rotate", "left"
    ])
    
# Add a hook to run the command at Qtile startup
...
screens = [
    ...
    Screen(
        right=bar.Gap(24),  # Assuming you want a gap for a vertical bar.
        top=bar.Bar(
            [
                widget.CurrentLayout(),
                widget.GroupBox(),
