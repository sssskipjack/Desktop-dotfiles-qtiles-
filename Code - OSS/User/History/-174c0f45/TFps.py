...
def set_cursor_size():
    # Replace '24' with your desired cursor size
    cursor_size = '12'
    cursor_theme = 'Adwaita'  # Replace with your cursor theme name if different
    # Set the cursor size for the X root window
    subprocess.run(['xsetroot', '-cursor_name', 'left_ptr', '-xcf', f'/usr/share/icons/{cursor_theme}/cursors/left_ptr', cursor_size])
