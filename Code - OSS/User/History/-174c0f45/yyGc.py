...
def autostart():
    ...
    # Start Picom and capture output
    process = subprocess.Popen(['picom', '--experimental-backends'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    output, error = process.communicate()
    if process.returncode != 0:
        print(f"Picom failed to start: {error}")
